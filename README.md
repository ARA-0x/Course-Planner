...
**نسخه فعلی: v1.1.0** (بیلد `versionCode=3`)
...
> ⚠️ **نکته مهم برای آپدیت:** چون `versionCode` از ۲ به ۳ افزایش یافته، اندروید نصب جدید را به‌عنوان «آپدیت» تشخیص می‌دهد. اگر نسخه قبلی را دارید، همان فایل جدید را نصب کنید. برای اطمینان از اینکه آخرین بیلد را دارید، بعد از نصب به صفحه **«تنظیمات»** بروید؛ در پایین صفحه باید `v1.1.0 (3)` به همراه هش کامیت بیلد نمایش داده شود.
