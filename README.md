...
**نسخه فعلی: v1.4.0** (بیلد `versionCode=6`)
...
> ⚠️ **نکته مهم برای آپدیت:** چون `versionCode` افزایش یافته، اندروید نصب جدید را به‌عنوان «آپدیت» تشخیص می‌دهد. برای اطمینان از اینکه آخرین بیلد را دارید، بعد از نصب به صفحه **«تنظیمات»** بروید؛ در پایین صفحه باید `v1.4.0 (6)` به همراه هش کامیت بیلد نمایش داده شود.
