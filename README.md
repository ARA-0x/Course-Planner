...
**نسخه فعلی: v1.5.0** (بیلد `versionCode=7`)
...
> ⚠️ **نکته مهم برای آپدیت:** چون `versionCode` افزایش یافته، اندروید نصب جدید را به‌عنوان «آپدیت» تشخیص می‌دهد. برای اطمینان از اینکه آخرین بیلد را دارید، بعد از نصب به صفحه **«تنظیمات»** بروید؛ در پایین صفحه باید `v1.5.0 (7)` به همراه هش کامیت بیلد نمایش داده شود.
...
5. با پنل **فیلترها** (مقطع کاردانی/کارشناسی/ارشد، واحد، روز کلاس، فقط دارای ساعت کلاسی) سریع درس موردنظر را پیدا کنید. تب‌های وضعیت (دروس من / همه دروس / ...) و مرتب‌سازی همیشه بالای لیست در دسترس‌اند و خلاصه فیلترهای فعال روی هدر پنل بسته دیده می‌شود.

### 📋 تاریخچه نسخه‌ها
- **v1.5.0 (بیلد ۷):** حذف تب تکراری «هدف برنامه‌ساز» (۳ تب تمیز)؛ عنوان‌های ۲خطی؛ سازگاری چیپ‌ها و بج‌ها با هر ۷ تم؛ عنوان «برنامه‌ساز»؛ کارت‌های جزوات هم‌سبک بقیه.
- **v1.4.0 (بیلد ۶):** تب‌های وضعیت و مرتب‌سازی پین‌شده بالای لیست؛ پنل «فیلترهای پیشرفته» با خلاصه فعال و انیمیشن نرم.
- **v1.3.0 (بیلد ۵):** فیلتر مقطع (کاردانی/کارشناسی/ارشد با مایگریشن امن ۳→۴)، فیلتر واحد و روز کلاس، پنل فیلتر جمع‌شونده.
