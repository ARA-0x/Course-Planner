...
**نسخه فعلی: v1.3.0** (بیلد `versionCode=5`)
...
> ⚠️ **نکته مهم برای آپدیت:** چون `versionCode` افزایش یافته، اندروید نصب جدید را به‌عنوان «آپدیت» تشخیص می‌دهد. برای اطمینان از اینکه آخرین بیلد را دارید، بعد از نصب به صفحه **«تنظیمات»** بروید؛ در پایین صفحه باید `v1.3.0 (5)` به همراه هش کامیت بیلد نمایش داده شود.
...
5. با پنل **فیلترها** (مقطع کاردانی/کارشناسی/ارشد، واحد، روز کلاس، فقط دارای ساعت کلاسی) سریع درس موردنظر را پیدا کنید.
